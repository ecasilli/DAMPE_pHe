...
void ChargeFit25_39()
{
	...
	TFile *InputFile = new TFile("PHe_MC_p_He-1PeV_v6r0p10p12p13_PSD_Histo.root");
...
//	InputFile->ls();
   ...
   char *PSDE_C = new char[25];
     for (int i=2; i<20; i++)
     {
       ...
       h[i]->GetXaxis()->SetTitle("PSD Global Energy (MeV)");
     }	
   ...
   char *PSDE_P_C = new char[25];
     for (int i=2; i<20; i++)
     {
       sprintf(PSDE_P_,"PSDE_P_%d",i);
       hP[i] = (TH1F*)InputFile->Get(PSDE_P_);
       hP[i]->SetTitle(" ");
       hP[i]->GetYaxis()->SetTitle("Normalized Counts");
       hP[i]->GetXaxis()->SetTitle("PSD Global Energy [MeV]");
     }	
   ...
   char *PSDE_He_C = new char[25];
     for (int i=2; i<20; i++)
     {
       sprintf(PSDE_He_,"PSDE_He_%d",i);
       hHe[i] = (TH1F*)InputFile->Get(PSDE_He_);
       hHe[i]->SetTitle(" ");
       hHe[i]->GetYaxis()->SetTitle("Normalized Counts");
       hHe[i]->GetXaxis()->SetTitle("PSD Global Energy [MeV]");
     }	
