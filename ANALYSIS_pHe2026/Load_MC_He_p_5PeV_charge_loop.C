...
void Load_MC_He_p_5PeV_charge_loop(){
    ...
    TFile *fout = new TFile("ROOT_FILES/PHe_MC_p_He_5PeV_charge_240bins_NewProgrCharge_asym_10sett26_nocut05.root", "RECREATE");
    fout->cd();
