...
std::string fout_name = "ROOT_FILES/unfold_results_pHe_2026_Orb120Month_3sigmaLow_6e5sigmaUp_PSDprogr_STKcharge450_comb_vert0e7_24sett26_wPHe_kernel_5bin.root";
std::string fdat_name = "TXT_FILES/flux_spectrum_pHe_2026_Orb120Month_3sigmaLow_6e5sigmaUp_PSDprogr_STKcharge450_comb_vert0e7_24sett26_wPHe_kernel_5bin.dat";
...
int unfolding_smooth_pHe() {
    ...
    std::string response_file = "ROOT_FILES/PHe_MC_p_He_5PeV_5binperdecade_3sigmaLow_6e5sigmaUp_PSDprogr_STKcharge450_comb_STKvert0e7_24sett26.root";
    std::string response_histo = "h2Ntrig_wgt";
    std::string data_file = "ROOT_FILES/PHe_skim_Orb120Month_5binperdecade_3sigmaLow_6e5sigmaUp_PSDprogr_STKcharge450_comb_STKvert0e7_24sett26.root";
    ...
    for(int i = 0; i < nx; i++) {
        ...
        outfile << em << "\t" << y << "\t" << yerr << "\t0.0\t" << lowE << "\t" << upE << "\n";
    }
