...
void ChargeFit3981_6309()
{
   PrintTimestamp("ChargeFit3981_6309.C");
	...
	TFile *InputFile = new TFile("../../ROOT_FILES/PHe_MC_p_He_5PeV_charge_240bins_corrected_20260525.root");
...
//******************************* HELIUM PEAK ***********************************// 
 cout << "\n * * * * * * HELIUM * * * * * * * \n" << endl;
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   plloHe[0]=0.01; plloHe[1]=1.0; plloHe[2]=1.0E-014; plloHe[3]=1.0E-05;
   plhiHe[0]=0.8; plhiHe[1]=4.0; plhiHe[2]=1.0E-11; plhiHe[3]=1.0E-01;
   svHe[0]=0.2; svHe[1]=2.0; svHe[2]=1.0E-13; svHe[3]=0.0002;
...
//******************************* PROTON PEAK ***********************************//	
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   pllo[0]=0.05; pllo[1]=0.5; pllo[2]=1.0E-14; pllo[3]=1.0E-10;
   plhi[0]=0.4; plhi[1]=2.0; plhi[2]=1.0E-11; plhi[3]=1.0E-04;
