...
//******************************* HELIUM PEAK ***********************************// 
 cout << "\n * * * * * * HELIUM * * * * * * * \n" << endl;
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   plloHe[0]=0.01; plloHe[1]=1.0; plloHe[2]=1.0E-013; plloHe[3]=1.0E-03;
   plhiHe[0]=0.8; plhiHe[1]=4.0; plhiHe[2]=1.0E-10; plhiHe[3]=1.0;
   svHe[0]=0.2; svHe[1]=2.0; svHe[2]=1.0E-11; svHe[3]=0.2;
...
//******************************* PROTON PEAK ***********************************//	
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   pllo[0]=0.05; pllo[1]=0.5; pllo[2]=1.0E-14; pllo[3]=1.0E-09;
