...
//******************************* PROTON PEAK ***********************************//	
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   pllo[0]=0.01; pllo[1]=0.5; pllo[2]=1.0E05; pllo[3]=1.0E-03;
   plhi[0]=0.1; plhi[1]=2.0; plhi[2]=1.0E09; plhi[3]=1.0;
   sv[0]=0.05; sv[1]=1.0; sv[2]=1.0E06; sv[3]=0.08;
...
//******************************* HELIUM PEAK ***********************************//	
  cout << "\n * * * * * * HELIUM * * * * * * * \n" << endl;
   ...
   plloHe[0]=0.05; plloHe[1]=1.0; plloHe[2]=1.0E05; plloHe[3]=1.0E-03;
   plhiHe[0]=1.0; plhiHe[1]=4.0; plhiHe[2]=1.0E09; plhiHe[3]=1.0;
   svHe[0]=0.6; svHe[1]=2.0; svHe[2]=1.0E06; svHe[3]=0.2;
