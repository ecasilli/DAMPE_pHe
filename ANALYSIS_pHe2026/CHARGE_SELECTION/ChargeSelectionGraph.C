...
mg->GetXaxis()->SetLimits(20, 40000.);
...
mg2->GetXaxis()->SetLimits(20, 40000.);
...
//		TF1 *FitFuncGausHMC  = new TF1("FitFuncGausHMC","[0]",25.,4000.0);
		TF1 *FitFuncGausHMC  = new TF1("FitFuncGausHMC","[0]",100.,100000.0);
...
mg3->GetXaxis()->SetLimits(20, 40000.);
...
/*
C1->SaveAs(Form("MPVPlot_%s_%s.pdf", ParticleTag.c_str(), timestamp.c_str()));
C5->SaveAs(Form("WidthPlot_%s_%s.pdf", ParticleTag.c_str(), timestamp.c_str()));
C7->SaveAs(Form("SigmaPlot_%s_%s.pdf", ParticleTag.c_str(), timestamp.c_str()));
*/
/*
C1->SaveAs(Form("MPVPlot_%s_%s_corr.pdf", ParticleTag.c_str(), timestamp.c_str()));
C5->SaveAs(Form("WidthPlot_%s_%s_corr.pdf", ParticleTag.c_str(), timestamp.c_str()));
C7->SaveAs(Form("SigmaPlot_%s_%s_corr.pdf", ParticleTag.c_str(), timestamp.c_str()));
*/
}
