...
cout << "\n * * * * * * *    MPV    * * * * * * * \n" << endl;
		...
		TGraphErrors *ChargeSelectionMPVH = new TGraphErrors(15, BGOEnergy, MPVH, E_BGOEnergy, E_MPVH);
	...
	//	TCanvas *C2 = new TCanvas("C2","C2",1000,800);
		...
		TGraphErrors *ChargeSelectionMPVHMC = new TGraphErrors(15, BGOEnergy, MPVHMC, E_BGOEnergy, E_MPVHMC);
		/*
		C2->SetLogx();
		C2->SetTickx();
		C2->SetTicky();
...
cout << "\n * * * * * * *    Width    * * * * * * * \n" << endl;
		...
		TGraphErrors *WidthH = new TGraphErrors(15, BGOEnergy, SigmaLH, E_BGOEnergy, E_SigmaLH);
...
//		TCanvas *C6 = new TCanvas("C6","C6",1000,800);
		...
		TGraphErrors *WidthHMC = new TGraphErrors(15, BGOEnergy, SigmaLHMC, E_BGOEnergy, E_SigmaLHMC);
/*		
		C6->SetLogx();
		C6->SetTickx();
		C6->SetTicky();
...
//		FitFuncGausH->FixParameter(1,0.0);
		...
		TGraphErrors *GausSigmaH = new TGraphErrors(15, BGOEnergy, SigmaGH, E_BGOEnergy, E_SigmaGH);
...
//		TCanvas *C8 = new TCanvas("C8","C8",1000,800);
		...
		TGraphErrors *GausSigmaHMC = new TGraphErrors(15, BGOEnergy, SigmaGHMC, E_BGOEnergy, E_SigmaGHMC);
/*		
		C8->SetLogx();
		C8->SetTickx();
		C8->SetTicky();
