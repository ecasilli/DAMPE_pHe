...
void ChargeSelectionGraph_2()
{
	PrintTimestamp("ChargeSelectionGraph_2.C");
	std::string timestamp = GetTimestamp();
	std::string ParticleTag = "H";
	//std::string ParticleTag = "He";

	std::ifstream in;	
	in.open("LangausResults_p_2.txt");
...
cout << "\n * * * * * * *    MPV    * * * * * * * \n" << endl;
		...
		TF1 *ChargeFitFuncH  = new TF1("ChargeFitFuncH","[0]",25.0,100000.0);

		ChargeFitFuncH->SetLineColor(kBlue+1);
		TCanvas *C1 = new TCanvas("C1","C1",1000,800);
		
		TGraphErrors *ChargeSelectionMPVH = new TGraphErrors(4, BGOEnergy, MPVH, E_BGOEnergy, E_MPVH);
		...
		TF1 *ChargeFitFuncHMC  = new TF1("ChargeFitFuncHMC","[0]",25.0,100000.0);

		ChargeFitFuncHMC->SetLineColor(kRed+1);
			
	//	TCanvas *C2 = new TCanvas("C2","C2",1000,800);
		
		TGraphErrors *ChargeSelectionMPVHMC = new TGraphErrors(4, BGOEnergy, MPVHMC, E_BGOEnergy, E_MPVHMC);
		...
		cout << "TString PMPVf= \"("   << ChargeFitFuncH->GetParameter(0)   << ")\";" << endl;
    	cout << "TString PMcMPVf= \"(" << ChargeFitFuncHMC->GetParameter(0) << ")\";" << endl;
...
DrawFitParameters(ChargeFitFuncH,  0.15, 0.65, kBlue+1, "Data", 1);
DrawFitParameters(ChargeFitFuncHMC, 0.4, 0.65, kRed+1,  "MC",   1);
...
cout << "\n * * * * * * *    Width    * * * * * * * \n" << endl;
		...
		TGraphErrors *WidthH = new TGraphErrors(4, BGOEnergy, SigmaLH, E_BGOEnergy, E_SigmaLH);
		...
		TGraphErrors *WidthHMC = new TGraphErrors(4, BGOEnergy, SigmaLHMC, E_BGOEnergy, E_SigmaLHMC);
		...
		cout << "TString PWidthf = \"("   << ChargeFitFuncWidthH->GetParameter(0)   << ")\";" << endl;
    	cout << "TString PMcWidthf = \"(" << ChargeFitFuncWidthHMC->GetParameter(0) << ")\";" << endl;
...
DrawFitParameters(ChargeFitFuncWidthH,  0.15, 0.65, kBlue+1, "Data", 1);
DrawFitParameters(ChargeFitFuncWidthHMC, 0.4, 0.65, kRed+1,  "MC",   1);
...
cout << "\n * * * * * * *    Sigma    * * * * * * * \n" << endl;
		...
		TGraphErrors *GausSigmaH = new TGraphErrors(4, BGOEnergy, SigmaGH, E_BGOEnergy, E_SigmaGH);
		...
		TGraphErrors *GausSigmaHMC = new TGraphErrors(4, BGOEnergy, SigmaGHMC, E_BGOEnergy, E_SigmaGHMC);
