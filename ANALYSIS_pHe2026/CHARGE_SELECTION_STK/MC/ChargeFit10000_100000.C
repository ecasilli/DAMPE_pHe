...
{
   PrintTimestamp("ChargeFit10000_100000.C");
 
	TFile *InputFile = new TFile("../../ROOT_FILES/PHe_MC_p_He_5PeV_STKcharge_adc_480bins_15sett26_nocut05.root");
...
/*     for (int i=2; i<20; i++)
     {
       sprintf(PSDE_,"PSDE_%d",i);
       h[i] = (TH1F*)InputFile->Get(PSDE_);
       h[i]->GetXaxis()->SetTitle("PSD Charge");
     }	
*/
   TH1F *hP[25];
   char *PSDE_P_ = new char[25];
   TCanvas *cP[25];    
   char *PSDE_P_C = new char[25];
     for (int i=1; i<5; i++)
     {
       sprintf(PSDE_P_,"h%02d_p",i);
       hP[i] = (TH1F*)InputFile->Get(PSDE_P_);
       hP[i]->SetTitle(" ");
       hP[i]->GetYaxis()->SetTitle("Normalized Counts");
       hP[i]->GetXaxis()->SetTitle("PSD Charge");
     }	

   TH1F *hHe[25];
   char *PSDE_He_ = new char[25];
   TCanvas *cHe[25];    
   char *PSDE_He_C = new char[25];
     for (int i=1; i<5; i++)
     {
       sprintf(PSDE_He_,"h%02d_he",i);
       hHe[i] = (TH1F*)InputFile->Get(PSDE_He_);
       hHe[i]->SetTitle(" ");
       hHe[i]->GetYaxis()->SetTitle("Normalized Counts");
...
//******************************* PROTON PEAK ***********************************//	
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   pllo[0]=1;  pllo[1]=30; pllo[2]=1.0E-12; pllo[3]=0.5;
   plhi[0]=100; plhi[1]=120; plhi[2]=1.0E-05; plhi[3]=50;
   sv[0]=15; sv[1]=60; sv[2]=1.0E-10; sv[3]=5;
...
//******************************* HELIUM PEAK ***********************************// 
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   plloHe[0]=5;  plloHe[1]=100; plloHe[2]=1.0E-11; plloHe[3]=5;
   plhiHe[0]=200; plhiHe[1]=400; plhiHe[2]=1.0E-05; plhiHe[3]=100;
   svHe[0]=20; svHe[1]=250; svHe[2]=1.0E-10; svHe[3]=20;
