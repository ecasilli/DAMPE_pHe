...
void ChargeFit_all()
{
   PrintTimestamp("ChargeFit_all.C");
 
	TFile *InputFile = new TFile("../../ROOT_FILES/PHe_STKcharge_adc_Orb120Month_480bins_16sett26_nocut05.root");
...
//******************************* PROTON PEAK ***********************************//	
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   plhi[0]=100; plhi[1]=120; plhi[2]=1.0E+09; plhi[3]=50;
...
//******************************* HELIUM PEAK ***********************************//	
  cout << "\n * * * * * * HELIUM * * * * * * * \n" << endl;
   ...
   plloHe[0]=5;  plloHe[1]=100; plloHe[2]=1.0E+02; plloHe[3]=5;
   plhiHe[0]=200; plhiHe[1]=400; plhiHe[2]=1.0E+09; plhiHe[3]=100;
