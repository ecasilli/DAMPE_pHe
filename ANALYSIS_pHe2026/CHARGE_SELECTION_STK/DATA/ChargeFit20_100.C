...
void ChargeFit20_100()
{
   PrintTimestamp("ChargeFit20_100.C");
...
//******************************* PROTON PEAK ***********************************//	
  ...
  // fr[1]=3.0*h1->GetMean();
   ...
   pllo[0]=1;  pllo[1]=30; pllo[2]=1.0E+04; pllo[3]=0.5;
   plhi[0]=100; plhi[1]=120; plhi[2]=1.0E+10; plhi[3]=50;
   sv[0]=15; sv[1]=60; sv[2]=1.0E+08; sv[3]=5;
...
//******************************* HELIUM PEAK ***********************************//	
  cout << "\n * * * * * * HELIUM * * * * * * * \n" << endl;
   ...
   plloHe[0]=5;  plloHe[1]=100; plloHe[2]=1.0E+04; plloHe[3]=5;
   plhiHe[0]=200; plhiHe[1]=400; plhiHe[2]=1.0E+10; plhiHe[3]=100;
   svHe[0]=20; svHe[1]=250; svHe[2]=1.0E+06; svHe[3]=20;
