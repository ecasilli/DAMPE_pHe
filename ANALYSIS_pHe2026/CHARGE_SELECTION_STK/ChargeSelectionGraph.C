...
cout << "\n * * * * * * *    MPV    * * * * * * * \n" << endl;
		...
		TF1 *ChargeFitFuncH  = new TF1("ChargeFitFuncH","[0]+[1]*log10(x)",25.0,100000.0);

		//ChargeFitFuncH->SetParameters(2.236, -0.6383, 0.622, -0.2396, 0.03738);	
		ChargeFitFuncH->SetLineColor(kBlue+1);
		TCanvas *C1 = new TCanvas("C1","C1",1000,800);
		
		TGraphErrors *ChargeSelectionMPVH = new TGraphErrors(12, BGOEnergy, MPVH, E_BGOEnergy, E_MPVH);
		...
		TF1 *ChargeFitFuncHMC  = new TF1("ChargeFitFuncHMC","[0]+[1]*log10(x)+[2]*log10(x)**2",25.0,100000.0);

		ChargeFitFuncHMC->SetLineColor(kRed+1);
			
	//	TCanvas *C2 = new TCanvas("C2","C2",1000,800);
		
		TGraphErrors *ChargeSelectionMPVHMC = new TGraphErrors(13, BGOEnergy, MPVHMC, E_BGOEnergy, E_MPVHMC);
		/*
		C2->SetLogx();
		C2->SetTickx();
		C2->SetTicky();
		*/
		...
		cout << "TString PMPVf= \"(" << ChargeFitFuncH->GetParameter(0) << "+(" << ChargeFitFuncH->GetParameter(1) << "*log10(BGO_EnergyG_SatCorr_ML_ions2))" << "+(" << ChargeFitFuncH->GetParameter(2) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**2)" << "+(" << ChargeFitFuncH->GetParameter(3) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**3)+(" << ChargeFitFuncH->GetParameter(4) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**4) )\";" << endl;
    	cout << "TString PMcMPVf= \"(" << ChargeFitFuncHMC->GetParameter(0) << "+(" << ChargeFitFuncHMC->GetParameter(1) << "*log10(BGO_EnergyG_SatCorr_ML_ions2))" << "+(" << ChargeFitFuncHMC->GetParameter(2) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**2)" << "+(" << ChargeFitFuncHMC->GetParameter(3) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**3)+(" << ChargeFitFuncHMC->GetParameter(4) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**4)" << ")\";" << endl;
...
mg->GetXaxis()->SetLimits(20, 150000.);
DrawFitParameters(ChargeFitFuncH,  0.15, 0.65, kBlue+1, "Data", 5);
DrawFitParameters(ChargeFitFuncHMC, 0.4, 0.65, kRed+1,  "MC",   5);

TLegend* leg = new TLegend(0.1352705,0.745306,0.3857715,0.8748195); //0.1352705,0.6745306,0.3857715,0.8748195,NULL,"brNDC"
leg->SetFillColor(0);
leg->SetBorderSize(0);
...
cout << "\n * * * * * * *    Width    * * * * * * * \n" << endl;
		...
		TF1 *ChargeFitFuncWidthH  = new TF1("ChargeFitFuncWidthH","[0]",25.0,100000.0);
		...
		TGraphErrors *WidthH = new TGraphErrors(13, BGOEnergy, SigmaLH, E_BGOEnergy, E_SigmaLH);
		...
		//TF1 *ChargeFitFuncWidthHMC  = new TF1("ChargeFitFuncWidthHMC","[0]+[1]*log10(x)+[2]*log10(x)**2+[3]*log10(x)**3+[4]*log10(x)**4",25.0,1000000.0);
		TF1 *ChargeFitFuncWidthHMC  = new TF1("ChargeFitFuncWidthHMC","[0]",25.0,1000000.0);
		ChargeFitFuncWidthHMC->SetLineColor(kRed+1);
		
//		TCanvas *C6 = new TCanvas("C6","C6",1000,800);
		
		TGraphErrors *WidthHMC = new TGraphErrors(13, BGOEnergy, SigmaLHMC, E_BGOEnergy, E_SigmaLHMC);
/*		
		C6->SetLogx();
		C6->SetTickx();
		C6->SetTicky();
*/
    	...
    	cout << "TString PMcWidthf = \"(" << ChargeFitFuncWidthHMC->GetParameter(0) << "+(" << ChargeFitFuncWidthHMC->GetParameter(1) << "*log10(BGO_EnergyG_SatCorr_ML_ions2))" << "+(" << ChargeFitFuncWidthHMC->GetParameter(2) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**2)" << "+(" << ChargeFitFuncWidthHMC->GetParameter(3) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**3)+(" << ChargeFitFuncWidthHMC->GetParameter(4) << "*log10(BGO_EnergyG_SatCorr_ML_ions2)**4)" << ")\";" << endl;
	...
	mg2->Add(WidthHMC);
	mg2->Draw("ap");
	ChargeFitFuncWidthHMC->Draw("same");

mg2->GetXaxis()->SetLimits(20, 150000.);
...
TLegend* leg1 = new TLegend(0.1352705,0.745306,0.3857715,0.8748195); //0.1352705,0.6745306,0.3857715,0.8748195,NULL,"brNDC"
leg1->SetFillColor(0);
...
//		FitFuncGausH->FixParameter(1,0.0);
		...
		TGraphErrors *GausSigmaH = new TGraphErrors(13, BGOEnergy, SigmaGH, E_BGOEnergy, E_SigmaGH);
...
//		TF1 *FitFuncGausHMC  = new TF1("FitFuncGausHMC","[0]",25.,4000.0);
		TF1 *FitFuncGausHMC  = new TF1("FitFuncGausHMC","[0]",25.,100000.0);
...
//		TCanvas *C8 = new TCanvas("C8","C8",1000,800);
		...
		TGraphErrors *GausSigmaHMC = new TGraphErrors(13, BGOEnergy, SigmaGHMC, E_BGOEnergy, E_SigmaGHMC);
/*		
		C8->SetLogx();
		C8->SetTickx();
		C8->SetTicky();
...
//		cout << "TString PGSigmaf = \"(" << FitFuncGausH->GetParameter(0) << "+(" << FitFuncGausH->GetParameter(1) << "*log10(BGO_EnergyG_SatCorr_ML_ions2))" << ")\";" << endl;
//    	cout << "TString PMcGSigmaf = \"(" << FitFuncGausHMC->GetParameter(0) << "+(" << FitFuncGausHMC->GetParameter(1) << "*log10(BGO_EnergyG_SatCorr_ML_ions2))" << ")\";" << endl;
...
mg3->GetXaxis()->SetLimits(20, 150000.);
DrawFitParameters(FitFuncGausH,   0.15, 0.65, kBlue+1, "Data", 1);
DrawFitParameters(FitFuncGausHMC, 0.4, 0.65, kRed+1,  "MC",   1);

TLegend* leg2 = new TLegend(0.1352705,0.745306,0.3857715,0.8748195); //0.1352705,0.6745306,0.3857715,0.8748195,NULL,"brNDC"
leg2->SetFillColor(0);
...
C7->SaveAs(Form("PLOTS/SigmaPlot_%s_corr.pdf", ParticleTag.c_str()));
*/
}
